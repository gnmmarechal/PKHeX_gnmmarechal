...
namespace PKHeX
{
    public partial class Form1 : Form
    {
        ...
        public static string Status = "Starting up PKHeX: GE";
        ...
        private void mainMenuExit(object sender, EventArgs e)
        {
            if (ModifierKeys == (Keys.Control | Keys.E)) // Hotkey Triggered
                if (DialogResult.Yes != Util.Prompt(MessageBoxButtons.YesNo, "Quit PKHeX: Gnmmarechal's Edition?")) return;
            Close();
        }
        ...
        {
            Properties.Settings.Default.OT = TB_OT.Text;
            Properties.Settings.Default.SID = TB_SID.Text;
            Properties.Settings.Default.TID = TB_TID.Text;
            //Properties.Settings.Default.Gender = Label_OTGender.Text;
        ...
        private void loadToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            TB_OT.Text = Properties.Settings.Default.OT;
            TB_SID.Text = Properties.Settings.Default.SID;
            TB_TID.Text = Properties.Settings.Default.TID;
            //Label_OTGender.Text = Properties.Settings.Default.Gender;
        }

        private void eggToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void CHK_AsEgg_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void TB_TID_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
